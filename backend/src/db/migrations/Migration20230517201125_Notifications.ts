...
export class Migration20230517201125 extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table "notification" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "event_id_id" int not null, "host_id" int not null, "participant_id" int not null, "message" varchar(255) not null);');
