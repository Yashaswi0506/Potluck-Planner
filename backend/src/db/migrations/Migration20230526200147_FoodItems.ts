...
export class Migration20230526200147 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "fooditems" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "event_id" int not null, "claim_id" int null, "item_name" varchar(255) not null, "item_type" varchar(255) not null, "item_quantity" varchar(255) not null);');
