...
export class Migration20230517195418 extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table "participant" ("user_id" int not null, "event_id" int not null, "is_host" varchar(255) not null default \'false\', "rsvp_response" varchar(255) not null default \'maybe\', constraint "participant_pkey" primary key ("user_id", "event_id"));');
