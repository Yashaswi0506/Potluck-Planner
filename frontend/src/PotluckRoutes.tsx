        ...
        <div className="navbar justify-center">
          <div className="navbar-center lg:flex">
            <ul className={"menu menu-horizontal"}>
              <li className="nav-link  normal-case text-xl block hover:text-blue-300 hover:no-underline focus:text-blue-300 focus:no-underline">
                <Link to="/">Home</Link>
              </li>
              {auth?.user != null ? (
                <>
                  ...
                  <li className="nav-link normal-case text-xl block hover:text-blue-300 hover:no-underline focus:text-blue-300 focus:no-underline">
                    <Link to="/after_login">My Potlucks</Link>
                  </li>
                </>
              ) : (
                <>
